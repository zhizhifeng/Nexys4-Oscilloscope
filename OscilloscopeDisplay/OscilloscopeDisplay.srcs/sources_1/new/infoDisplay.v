...
module infoDisplay (input clk,
    ...
    parameter NUM_CHARS = 63; // total number of characters
    ...
    //CH1 VERTICAL SCALE
    assign {x_positions[3],y_positions[3], rgbs[3], char_datas[3]} = {11'd56 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_N};
    assign {x_positions[4],y_positions[4], rgbs[4], char_datas[4]} = {11'd70 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_E};
    assign {x_positions[5],y_positions[5], rgbs[5], char_datas[5]} = {11'd84 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_L};
    assign {x_positions[6],y_positions[6], rgbs[6], char_datas[6]} = {11'd98 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_PERIOD};
    assign {x_positions[7],y_positions[7], rgbs[7], char_datas[7]} = {11'd112 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_O};
    ...
    //CH2 CHARACTERS
    assign {x_positions[23],y_positions[23], rgbs[23], char_datas[23]} = {11'd364 + `EX_CONST_1, 10'd1007, `BLUE, `CHAR_C};
    assign {x_positions[24],y_positions[24], rgbs[24], char_datas[24]} = {11'd378 + `EX_CONST_1, 10'd1007, `BLUE, `CHAR_H};
    assign {x_positions[25],y_positions[25], rgbs[25], char_datas[25]} = {11'd392 + `EX_CONST_1, 10'd1007, `BLUE, `CHAR_2};
    //CH2 VERTICAL SCALE
    assign {x_positions[26],y_positions[26], rgbs[26], char_datas[26]} = {11'd420 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_7};
    assign {x_positions[27],y_positions[27], rgbs[27], char_datas[27]} = {11'd434 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_1};
    assign {x_positions[28],y_positions[28], rgbs[28], char_datas[28]} = {11'd448 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_0};
    assign {x_positions[29],y_positions[29], rgbs[29], char_datas[29]} = {11'd462 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_0};
    assign {x_positions[30],y_positions[30], rgbs[30], char_datas[30]} = {11'd476 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_7};
    assign {x_positions[31],y_positions[31], rgbs[31], char_datas[31]} = {11'd490 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_m};
    assign {x_positions[32],y_positions[32], rgbs[32], char_datas[32]} = {11'd504 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_s};
    //CH2 MAX & MIN
    assign {x_positions[33],y_positions[33], rgbs[33], char_datas[33]} = {11'd532 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_1};
    assign {x_positions[34],y_positions[34], rgbs[34], char_datas[34]} = {11'd546 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_0};
    assign {x_positions[35],y_positions[35], rgbs[35], char_datas[35]} = {11'd560 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_0};
    assign {x_positions[36],y_positions[36], rgbs[36], char_datas[36]} = {11'd574 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_7};
    ...
    assign {x_positions[40],y_positions[40], rgbs[40], char_datas[40]} = {11'd630 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_7};
    assign {x_positions[41],y_positions[41], rgbs[41], char_datas[41]} = {11'd644 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_1};
    assign {x_positions[42],y_positions[42], rgbs[42], char_datas[42]} = {11'd658 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_0};
    assign {x_positions[43],y_positions[43], rgbs[43], char_datas[43]} = {11'd672 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_0};
    ...
    //HORIZONAL SCALE
    assign {x_positions[46],y_positions[46], rgbs[46], char_datas[46]} = {11'd742 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_1};
    assign {x_positions[47],y_positions[47], rgbs[47], char_datas[47]} = {11'd756 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_0};
    assign {x_positions[48],y_positions[48], rgbs[48], char_datas[48]} = {11'd770 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_0};
    assign {x_positions[49],y_positions[49], rgbs[49], char_datas[49]} = {11'd784 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_7};
    ...
    assign {x_positions[57],y_positions[57], rgbs[57], char_datas[57]} = {11'd938 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_1};
    //TRI THRESHOLD
    assign {x_positions[58],y_positions[58], rgbs[58], char_datas[58]} = {11'd966 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_1};
    assign {x_positions[59],y_positions[59], rgbs[59], char_datas[59]} = {11'd980 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_0};
    assign {x_positions[60],y_positions[60], rgbs[60], char_datas[60]} = {11'd994 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_0};
    assign {x_positions[61],y_positions[61], rgbs[61], char_datas[61]} = {11'd1008 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_m};
    assign {x_positions[62],y_positions[62], rgbs[62], char_datas[62]} = {11'd1022 + `EX_CONST_1, 10'd1007, `WHITE, `CHAR_V};
